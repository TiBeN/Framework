...
/**
 * Test cases for class NumericValidator
 * 
...
{
    // Start of user code NumericValidatorTest.attributes
	// Place additional tests attributes here.  
	// End of user code

    public function setUp()
    {
        // Start of user code NumericValidatorTest.setUp
    ...
    {
        // Start of user code NumericValidatorTest.tearDown
    ...
    // Start of user code NumericValidatorTest.methods
